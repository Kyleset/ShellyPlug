<#
    .SYNOPSIS
    The purpose of this function is to switch the state of the Shelly Plug to on for a Shelly v2 API plug.
    .DESCRIPTION
...
function Switch-ShellyPlugOn () {
    ...
    $response = invoke-webrequest -uri ("http://" + $shellyIP + "/rpc/Switch.Set?id=0&on=true") -method $method
